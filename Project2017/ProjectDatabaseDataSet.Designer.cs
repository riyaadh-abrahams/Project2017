...
namespace Project2017 {
    ...
    public partial class ProjectDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomersRow AddCustomersRow(string CustomerID, string Name, string Surname, string Address, string EmailAddress, string Phone_Number) {
...
namespace Project2017.ProjectDatabaseDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_EmailAddress = 1 AND [EmailAddress] IS NULL) OR ([EmailAddress] = @Original_EmailAddress)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([CustomerID], [Name], [Surname], [Address], [EmailAddress]) VALUES (@CustomerID, @Name, @Surname, @Address, @EmailAddress);
SELECT CustomerID, Name, Surname, Address, EmailAddress FROM Customers WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [CustomerID] = @CustomerID, [Name] = @Name, [Surname] = @Surname, [Address] = @Address, [EmailAddress] = @EmailAddress WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_EmailAddress = 1 AND [EmailAddress] IS NULL) OR ([EmailAddress] = @Original_EmailAddress)));
SELECT CustomerID, Name, Surname, Address, EmailAddress FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Project2017.Properties.Settings.Default.Project2017DBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, Name, Surname, Address, EmailAddress FROM dbo.Customers";
        ...
        public virtual int Fill(ProjectDatabaseDataSet.CustomersDataTable dataTable) {
        ...
        public virtual ProjectDatabaseDataSet.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ProjectDatabaseDataSet.CustomersDataTable dataTable = new ProjectDatabaseDataSet.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ProjectDatabaseDataSet.CustomersDataTable dataTable) {
        ...
        public virtual int Delete(string Original_CustomerID, string Original_Name, string Original_Surname, string Original_Address, string Original_EmailAddress) {
        ...
        public virtual int Insert(string CustomerID, string Name, string Surname, string Address, string EmailAddress) {
            if ((CustomerID == null)) {
        ...
        public virtual int Update(string CustomerID, string Name, string Surname, string Address, string EmailAddress, string Original_CustomerID, string Original_Name, string Original_Surname, string Original_Address, string Original_EmailAddress) {
            if ((CustomerID == null)) {
                throw new global::System.ArgumentNullException("CustomerID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string Address, string EmailAddress, string Original_CustomerID, string Original_Name, string Original_Surname, string Original_Address, string Original_EmailAddress) {
            return this.Update(Original_CustomerID, Name, Surname, Address, EmailAddress, Original_CustomerID, Original_Name, Original_Surname, Original_Address, Original_EmailAddress);
        }
    }
